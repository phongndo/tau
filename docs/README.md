...
- [Surface and output-path pass](benchmarks/perf-pass-2026-09-25.md) — production TauTerminal/Ghostty surface, main transport and packaged results; one rejected daemon experiment.
